...
const SCHEDULE = [
  { time: "10:30", title: "Сбор гостей", note: "Дворец бракосочетания №1" },
  { time: "11:00", title: "Церемония бракосочетания" },
  { time: "12:00", title: "Фотосессия" },
  { time: "13:00", title: "Прогулка на катере по рекам и каналам" },
  { time: "15:30", title: "Фотосессия во Владимирском дворце" },
  { time: "17:00", title: "Банкет", note: "Ресторан Percorso" },
  { time: "21:00", title: "Запуск воздушных фонариков" },
